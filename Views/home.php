  ...
  <div class="row no-gutters">
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
      <a href="#" class="card card-overflow card-scale no-radius mb-0">
        <div class="bg-image" style="background:url(<?=$baseUrl?>/Views/assets/img/a-1.png)no-repeat;" data-overlay="2"></div>
        <div class="ct_body">
    ...
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
      <a href="#" class="card card-overflow card-scale no-radius mb-0">
        <div class="bg-image" style="background:url(<?=$baseUrl?>/Views/assets/img/a-2.png)no-repeat;" data-overlay="2"></div>
        <div class="ct_body">
          <div class="ct_body_caption">
    ...
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
      <a href="#" class="card card-overflow card-scale no-radius mb-0">
        <div class="bg-image" style="background:url(<?=$baseUrl?>/Views/assets/img/a-3.png)no-repeat;" data-overlay="2"></div>
        <div class="ct_body">
          <div class="ct_body_caption">
