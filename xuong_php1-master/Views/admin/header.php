                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="<?=$baseUrl?>admin.php?page=product_list">Product list</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="<?= $baseUrl ?>/Views/admin/images/logo.png"
                            alt="Logo"></a>
                    <a class="navbar-brand hidden" href="./"><img src="<?= $baseUrl ?>/Views/admin/images/logo2.png"
                            alt="Logo"></a>
                ...
                <div class="header-menu">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="<?= $baseUrl ?>/Views/admin/images/avatar/1.jpg"></span>
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="<?= $baseUrl ?>/Views/admin/images/avatar/2.jpg"></span>
                                    <div class="message media-body">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="<?= $baseUrl ?>/Views/admin/images/avatar/3.jpg"></span>
                                    <div class="message media-body">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="<?= $baseUrl ?>/Views/admin/images/avatar/4.jpg"></span>
                                    <div class="message media-body">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="<?= $baseUrl ?>/Views/admin/images/admin.jpg"
                                alt="User Avatar">
                        </a>
